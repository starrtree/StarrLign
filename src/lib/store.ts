...
export const useStore = create<AppState>((set, get) => ({
  ...
  openNewTaskModal: (projectId = null) => set({
    editingTaskId: null,
    isDetailMode: false,
    isModalOpen: true,
    autoSetProjectForTask: projectId,
  }),
  openTaskDetails: (id) => set({ editingTaskId: id, isDetailMode: true, isModalOpen: true }),
  openTaskEditor: (id) => set({ editingTaskId: id, isDetailMode: false, isModalOpen: true }),
